...
public interface ISeatingPlanStore
{
    /// <summary>
    ...
    /// <summary>
    /// Sets the table number for a specific guest. Null will unassign them from any table. Restricted to Admin users.
    /// </summary>
    public void SetTableForGuest(string guestId, string? tableId);
    
    /// <summary>
    /// Get all the tables in the seating plan, including empty tables. Restricted to Admin users.
    /// </summary>
