...
public record BackgroundImage(string Url, bool IsDark, string Width = "100%", Colour? OverlayColour = null, double Parallax = 0, bool ExtraContrast = false, Colour? CustomTextColour = null) : IBackground
{
    ...
    public Colour GetTextColour()
    {
        if (CustomTextColour == null)
            return IsDark ? Colour.White : Colour.DarkGrey;
        else 
